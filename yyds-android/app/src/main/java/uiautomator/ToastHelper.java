...
//        toastView = LayoutInflater.from(context).inflate(context.getResources().getLayout(R.layout.main), null);
//        toastView = TextView.inflate(context, 0, null);
        // View无法成功初始化
        toastView = new TextView(context);
        if (toastView == null) {
            System.out.println("toastview == null");
        }
