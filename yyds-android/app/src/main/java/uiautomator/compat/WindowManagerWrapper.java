...
public class WindowManagerWrapper {
    ...
    public DisplayMetrics getDisplayMetrics() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        DisplayMetrics displayMetrics = new DisplayMetrics();
        ExtSystem.printInfo("defaultPlay---->", windowManager.getClass());
        Object defaultPlay = windowManager.getClass().getMethod("getDefaultDisplay").invoke(windowManager);

        defaultPlay.getClass().getMethod("getMetrics", DisplayMetrics.class).invoke(defaultPlay, displayMetrics);
