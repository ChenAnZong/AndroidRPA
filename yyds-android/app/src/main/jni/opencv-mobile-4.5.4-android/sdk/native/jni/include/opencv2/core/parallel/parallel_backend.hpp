 ...
 *
 * @note This call is not thread-safe. Consider calling this function from the `screen_shot_save()` before any other OpenCV processing functions (and without any other created threads).
 */
